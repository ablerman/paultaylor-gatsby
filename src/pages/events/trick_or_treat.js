...
import photos from '../../constants/trickortreat'
...
class TrickOrTreat extends React.Component {
    constructor(props) {
        super(props);
            ...
            <React.Fragment>
                ...
                <div>
                    ...
                    <div className={this.props.classes.root}>
                        <PhotoPage title="Trick Or Treat" photos={photos}/>
                    </div>
                </div>
            </React.Fragment>
        );
...
export default withStyles(styles)(TrickOrTreat);
